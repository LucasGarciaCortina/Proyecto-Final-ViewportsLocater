...
class MiradorEndpoints
{
            ...
            content: new OA\JsonContent(
                ...
                properties: [
                    ...
                    new OA\Property(
                        ...
                        items: new OA\Items(type: 'integer'),
                        example: [1, 2, 3],
                        description: 'IDs de los tags a asignar al mirador'
                    ),
                    new OA\Property(
                        property: 'fotos',
                        type: 'array',
                        ...
                        example: ['/storage/fotos/foto1.jpg', '/storage/fotos/foto2.jpg'],
                        description: 'URLs de las fotos a asociar al mirador'
                    ),
                ]
            )
        ),
    ...
    #[OA\Post(
        path: '/api/miradores/{id}/tags',
        operationId: 'attachTagsToMirador',
        summary: 'Asignar tags a un mirador (reemplaza los existentes)',
        tags: ['Miradores'],
        parameters: [
            new OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'integer'), example: 1)
        ],
        ...
        responses: [
            new OA\Response(
                response: 200,
                description: 'Tags asignados correctamente',
                content: new OA\JsonContent(
                    properties: [
                        new OA\Property(property: 'mirador', ref: '#/components/schemas/Mirador'),
